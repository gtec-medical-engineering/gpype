"""
g.Nautilus - real-time EEG acquisition, filtering and display

Bandpass 1-30 Hz, then notches at 50 and 60 Hz so the example runs on
either mains standard. The g.Nautilus samples at 250 or 500 Hz; fs
below must match the rate the connected device supports.

Requires: a g.Nautilus, and pip install gpype[all]
Run: python example_devices_gnautilus.py
"""
import gpype as gp
