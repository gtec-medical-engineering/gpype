"""
Basic CSV Plot Example - Offline Data Analysis and Visualization

This example demonstrates how to load and visualize data recorded from g.Pype
CsvWriter nodes. It complements example_basic_csv_writer_record.py by showing
how to analyze the recorded data offline using standard Python tools.

What this example shows:
- Loading CSV files created by g.Pype CsvWriter
...
Expected input:
CSV files generated by example_basic_csv_writer_record.py containing:
- Column 0: Timestamp
...
Workflow:
1. Run example_basic_csv_writer_record.py to create data
...
Usage:
    python example_basic_csv_writer_plot.py
